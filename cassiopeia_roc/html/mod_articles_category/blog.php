...
#' . $modId . ' img.blog-layout-img:is(:hover, :focus) {
	filter: grayscale(1);
}', ['name' => $modId]);
?>
<div id="<?php echo $modId; ?>" class="mod-articlescategory category-module mod-list">
	<?php if ($grouped) : ?>
		...
		<div class="grid">
			...
			<?php require ModuleHelper::getLayoutPath('mod_articles_category', $params->get('layout', 'blog') . '_items'); ?>
		</div>
		<?php endforeach; ?>
	<?php else : ?>
        <div class="grid">
